...
│   └── src/...
│
├── distributed_message_queue/   ← Distributed Message Queue (Kafka)
│   ├── README.md
│   ├── INTERVIEW_CHEATSHEET.md
│   └── src/...
│
├── ad_click_aggregation_system/ ← Ad Click Event Aggregation
│   ├── README.md
│   ├── INTERVIEW_CHEATSHEET.md
│   └── src/...
│
...
│   └── src/...
│
├── s3_object_storage_system/    ← S3-like Object Storage
│   ├── README.md
│   ├── INTERVIEW_CHEATSHEET.md
│   └── src/...
│
...
│   └── src/...
│
├── digital_wallet_system/      ← Digital Wallet (Event Sourcing)
│   ├── README.md
│   ├── INTERVIEW_CHEATSHEET.md
│   └── src/...
│
